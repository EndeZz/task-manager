...
(function (global) {
  ...
  function onClick() {
    document.body.onclick = function (e) {
      ...
      // other variables
      let date; let month; let year; let btn; let option; let
        dateObj;
  ...
  function drawCalendar(option) {
    ...
    if (targetedElementBy === 'id') {
      ...
      for (i = 0, len = elemArr.length; i < len; i += 1) {
