...
// const deleteFileBtns = document.querySelectorAll<HTMLElement>('.delete-file');

// deleteFileBtns.forEach(deleteFile => {
//     deleteFile.addEventListener('click', () => {
//         deleteFile.closest('.new-task__insert-file').setAttribute('style', "display:none;")
//       });
// })
...
// const typeContentInput = document.querySelector('.new-task__type-input');
// const titleContentInput = document.querySelector('.new-task__title-input');
// const descrContentInput = document.querySelector('.new-task__descr-input');
// const calendarContentInput = document.querySelector('.calendar-deadline__input');
// const initiatorContentInput = document.querySelector('.new-task__input');
// const responsContentInput = document.querySelector('.respons-block__input');
...
//         let INITIATOR = '';
//         let RESPONS = '';
//         if (typeContentInput.value.length > 0) {
//           TYPE = typeContentInput.value.trim();
//         } else {
//           typeContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         }
//         if (titleContentInput.value.length > 0) {
//           TITLE = titleContentInput.value.trim();
//         } else {
//           titleContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         }
//         if (descrContentInput.value.length > 0) {
//           DESCR = descrContentInput.value.trim();
//         } else {
//           descrContentInput.style.border = '1px solid red';
//           // document.querySelector('.new-user__fill-field').classList.add('typeHide');
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         }
//         if (calendarContentInput.value.length > 0) {
//           CALENDAR = calendarContentInput.value.trim();
//         } else {
//           calendarContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         }
//         if (initiatorContentInput.value.length > 0) {
//           INITIATOR = initiatorContentInput.value.trim();
//         } else {
//           initiatorContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')

//         }
//         if (responsContentInput.value.length > 0) {
//           RESPONS = responsContentInput.value.trim();
//         } else {
//           responsContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         }
//         if (TYPE.length === 0) {
//           console.log('1', 1)
...
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         } else {
//           typeContentInput.style.border = '1px solid #D8E3EC';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 0;')
//         }
//         if (TITLE.length === 0) { 
//           console.log('2', 2)
//           titleContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         } else {
//           titleContentInput.style.border = '1px solid #D8E3EC';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 0;')
//         }
//         if (DESCR.length === 0) {
//           descrContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         } else {
//           descrContentInput.style.border = '1px solid #D8E3EC';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 0;')
//         }
...
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         } else {
//           calendarContentInput.style.border = '1px solid #D8E3EC';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 0;')
//         }
...
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         } else {
//           initiatorContentInput.style.border = '1px solid #D8E3EC';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 0;')
//         }
//         if (RESPONS.length === 0) {
//           responsContentInput.style.border = '1px solid red';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 1;')
//         } else {
//           responsContentInput.style.border = '1px solid #D8E3EC';
//           document.querySelector('.new-task__fill-circle').setAttribute('style', 'opacity: 0;')
//         }
//       });
//   }
